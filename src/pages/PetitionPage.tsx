    ...
    <div className="min-h-screen bg-cyber-black">
      ...
      <main className="container mx-auto px-4 pt-24 pb-12 max-w-4xl">
        <div className="glass-panel rounded-lg border-2 border-[#F97316]/30">
          ...
          <div className="space-y-6 text-white/80 leading-relaxed">
            ...
            <p>
              As concerned African youth, we write to you with urgency: it is time for CAF to end its AFCON sponsorship
              deal with Total Energies and refuse to allow African football to be tainted by the image of a fossil fuel
              giant that is undermining our future.
            </p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p>
                  Total has repeatedly presented itself as a company committed to sustainability, while continuing to
                  develop new fossil projects and delay meaningful climate action. Its PR campaigns are increasingly
                  judged by independent regulators as "misleading." (Financial Times) Sponsorship of AFCON gives it a
                  veneer of legitimacy and "clean credentials" at precisely the moment it is doing the opposite.
                </p>
              </div>

              <div>
                <h3 className="font-bold text-[#F97316] mb-2">
                  Human rights abuses and community harm on the continent
                </h3>
                <p>
                  In Cabo Delgado, Mozambique, Total's LNG project in Afungi has been tied to forced displacements,
                  interruption of livelihoods, and serious allegations that security forces guarding the site detained
                  civilians in containers, beat them, deprived them of food, and caused deaths. (360 Mozambique) In East
                  Africa (EACOP, Uganda/Tanzania), the pipeline project threatens over 100,000 people with displacement,
                  undermines water sources, and violates land rights, while compensation practices and safeguards have
              ...
              <div>
                ...
                <p>
                  ...
                  ecosystems, and the climate. The resources spent lobbying, delaying emissions reductions, and
                  resisting regulation could instead fund clean energy, health, education, and resilience across Africa.
                  That they choose to sponsor AFCON and attempt to lull our youth into a false sense of security,
                  instead of repairing the damage they've done to our continent, is morally bankrupt.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  CAF and AFCON have deep emotional resonance across the continent. By allowing Total to sponsor our
                  game, we endorse their attempt to seduce our youth with the illusion of benevolence, while they
                  continue extraction and environmental destruction behind the scenes. That is unacceptable. Football
                  should unite us, not be sold as a fig leaf for exploitation. (Greenpeace)
                </p>
              </div>
            </div>

            <p>
              CAF stands at a crossroads. You can choose to protect the integrity of African football, align with the
              values of youth, community, and environment — or you can continue to partner with a company whose core
              business is antithetical to a livable future. The decision is clear.
            </p>

            <p className="font-semibold">
              We, the undersigned (fans, civil society groups, climate justice advocates, concerned citizens), call upon
              you to:
            </p>

            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                Immediately terminate the sponsorship deal with Total Energies (including all naming and branding
                rights)
              </li>
              <li>Publicly affirm that CAF will refuse future partnership with fossil fuel corporations</li>
              <li>
                Redirect outreach and sponsorship efforts toward clean energy, sustainable development, or ethical
                funding sources
              </li>
            </ul>

            <p>
              We demand not only a symbolic gesture but a structural change: African football must no longer be
              complicit in climate injustice. You have the power to act — and the world is watching.
            </p>
      ...
      <Dialog open={showThankYou} onOpenChange={setShowThankYou}>
        <DialogContent className="bg-cyber-darkgray border-2 border-[#F97316] shadow-neon-orange max-w-md">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold text-[#F97316] text-center">Thank You for Signing!</DialogTitle>
            <DialogDescription className="text-white/80 text-center space-y-4 pt-4">
              <p className="text-lg">Your signature has been added to the petition.</p>
              <p>
